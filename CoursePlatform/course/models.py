...
# Creates the table name course_category with different fields like name,slug and created.we dont need to mention
# primary key here coz it is maintained by framework
...
class Course(models.Model):
    ...
    prerequisite = models.TextField(null=True, help_text="What Student Should Learn Before Enrolling to this Course",
                                    blank=True)
